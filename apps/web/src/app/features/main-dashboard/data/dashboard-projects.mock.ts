...
export const MOCK_DASHBOARD_PROJECTS: DashboardProject[] = [
  {
    ...
    workspace: {
      ...
      kind: 'team',
      role: 'owner',
      capabilities: { canEdit: true, canManageMembers: true, canRestoreSnapshots: true, canImportContracts: true },
    },
    status: 'running',
  ...
  },
  {
    ...
    workspace: {
      ...
      kind: 'team',
      role: 'editor',
      capabilities: { canEdit: true, canManageMembers: false, canRestoreSnapshots: true, canImportContracts: true },
    },
    status: 'running',
